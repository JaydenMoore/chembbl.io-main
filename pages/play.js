      ...
      <div className="flex flex-col items-center justify-center overscroll-contain">
        ...
        <div className="py-2">
          <input
            ...
            />
          <button className="bg-white focus:ring-1 focus:ring-black focus:outline-none w-[4.5rem] h-[2.4rem] p-2 border-2 rounded-md border-slate-100 ml-[0.5rem]" onClick={()=>{
              <p>guess</p>
            }}>
            </button>
        </div> 
